...
class _PokedexScreenState extends State<PokedexScreen> {
  ...
  List<Map<String, dynamic>> _generateFullPokedexList(List<dynamic> caughtPokemon) {
                      ...
                      child: Padding(
                        ...
                        child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final bool isCaught = !pokemon.containsKey('caught') || pokemon['caught'] != false;
                            
                            return GestureDetector(
                              onTap: () => _showPokemonDetails(pokemon, isCaught),
                              child: Container(
                                decoration: BoxDecoration(
                                  color: Colors.white,
