...
SELECT 
    ...
    Pokemon.active AS active,
    CatchCodes.catch_code AS catch_code
FROM Pokemon
JOIN CatchCodes ON Pokemon.pokemon_id = CatchCodes.pokemon_id;
...
SELECT 
    ...
    Pokemon.pokemon_id AS PokemonNumber, 
