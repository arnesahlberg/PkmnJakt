...
curl -X POST http://127.0.0.1:8080/set_user_name \
    -H "Content-Type: application/json" \
    -d '{"id": "22222", "name": "Sture Stör", "token":"'$TOKEN2'"}'

# find some pokemon
curl -X POST http://127.0.0.1:8080/found_pokemon \
    -H "Content-Type: application/json" \
    -d '{"user_id": "11111", "pokemon_id": "1", "token" : "'$TOKEN'"}'

curl -X POST http://127.0.0.1:8080/found_pokemon \
    -H "Content-Type: application/json" \
    -d '{"user_id": "22222", "pokemon_id": "6", "token" : "'$TOKEN2'"}'

curl -X POST http://127.0.0.1:8080/found_pokemon \
    -H "Content-Type: application/json" \
    -d '{"user_id": "11111", "pokemon_id": "92", "token" : "'$TOKEN'"}'

curl -X POST http://127.0.0.1:8080/found_pokemon \
    -H "Content-Type: application/json" \
    -d '{"user_id": "11111", "pokemon_id": "111", "token" : "'$TOKEN'"}'

curl -X POST http://127.0.0.1:8080/found_pokemon \
    -H "Content-Type: application/json" \
    -d '{"user_id": "22222", "pokemon_id": "121", "token" : "'$TOKEN2'"}'

curl -X POST http://127.0.0.1:8080/found_pokemon \
    -H "Content-Type: application/json" \
    -d '{"user_id": "11111", "pokemon_id": "31", "token" : "'$TOKEN'"}'

curl -X POST http://127.0.0.1:8080/found_pokemon \
    -H "Content-Type: application/json" \
    -d '{"user_id": "11111", "pokemon_id": "32", "token" : "'$TOKEN'"}'


# view pokemon found by user
curl -X POST http://127.0.0.1:8080/view_found_pokemon \
    -H "Content-Type: application/json" \
    -d '{"user_id": "11111", "n": 10, "token" : "'$TOKEN'"}'
