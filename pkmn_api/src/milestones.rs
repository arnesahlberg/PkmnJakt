    ...
    pub static ref MILESTONE_DEFINITIONS: HashMap<String, MilestoneDefinition> = {
        ...
        map.insert(
            ...
            MilestoneDefinition {
                ...
                display_text: "Legendarisk fågel Articuno fångad!".to_string(),
        ...
        map.insert(
            ...
            MilestoneDefinition {
                ...
                display_text: "Legendarisk fågel Zapdos fångad!".to_string(),
        ...
        map.insert(
            ...
            MilestoneDefinition {
                ...
                display_text: "Legendarisk fågel Moltres fångad!".to_string(),
        ...
        map.insert(
            ...
            MilestoneDefinition {
                ...
                display_text: "Legendarisk Pokémon Mewtwo fångad!".to_string(),
        ...
        map.insert(
            ...
            MilestoneDefinition {
                ...
                display_text: "Legendarisk Pokémon Mew fångad!".to_string(),
